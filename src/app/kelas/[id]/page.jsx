				...
				<div className='mt-4'>
					...
					<div className='bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center space-y-2 mt-1'>
						...
						<Link
							...
							<div>Catat Poin Master Siswa</div>
						</Link>
						<hr className='border-gray-100' />
						{isWaliKelas && (
							<>
						...
						{isWaliKelas && (
							<>
								<Link
									...
									<div>Riwayat Absensi (Harian)</div>
								</Link>
								<hr className='border-gray-100' />
							</>
						)}
						...
						{isWaliKelas && (
							<>
								<Link
									...
									<div>Laporan Absensi (Harian)</div>
								</Link>
								<hr className='border-gray-100' />
							</>
						)}
						<Link
							...
							<svg
								...
								<path
									strokeLinecap='round'
									strokeLinejoin='round'
									d='M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m5.231 13.481L15 17.25m-4.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9ZM9.75 16.5v.75m3-3v3M15 12v5.25'
								/>
							</svg>
							<div>Absensi Mapel</div>
						</Link>
						...
						{siswaList.length > 0 ? (
							siswaList.map((siswa, index) => (
								<Link
									...
									{/* Icon Avatar / User */}
									<div className='bg-indigo-50 p-2 rounded-full text-indigo-600 relative'>
										<svg
											xmlns='http://www.w3.org/2000/svg'
											fill='none'
											viewBox='0 0 24 24'
											...
											{(() => {
												...
												return (
													<div className='flex gap-1 ml-1'>
														{positif > 0 && <span className='text-[10px] bg-green-100 text-green-700 px-1.5 py-0.5 rounded-full font-bold'>+{positif}</span>}
														{negatif > 0 && <span className='text-[10px] bg-red-100 text-red-700 px-1.5 py-0.5 rounded-full font-bold'>-{negatif}</span>}
													</div>
												);
											})()}
										</div>
