...
const DeleteButton = ({ onClick, className = '' }) => {
	return (
		<button
			onClick={onClick}
			className={`group relative flex h-14 w-14 flex-col items-center justify-center overflow-hidden rounded-xl  bg-red-400 hover:bg-red-600 ${className}`}>
			{/* Icon Sampah Masuk (Animasi Spin) */}
			<svg
			...
			{/* Tutup Tong Sampah (Animasi Rotate) */}
			<svg
				width='16'
				fill='none'
				viewBox='0 0 39 7'
